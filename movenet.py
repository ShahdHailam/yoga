...
Original file is located at
    https://colab.research.google.com/drive/1zYSfHlmcAVZ9I3f49WHNdksdHXkh1B4Y
"""

!pip install tflite-runtime

import sys
sys.path.insert(0,'/content/DataTypes.py')
...
from DataTypes import BodyPart
from DataTypes import Person
from DataTypes import person_from_keypoints_with_scores
import numpy as np
...
class Movenet(object):
  ...
  def _crop_and_resize(
      ...
      crop_size_x:int , crop_size_y:int ) -> np.ndarray:
    ...
    output_image = cv2.copyMakeBorder(output_image, padding_top, padding_bottom,
                                      ...
                                      cv2.BORDER_CONSTANT)
    output_image = cv2.resize(output_image, (crop_size_x[0], crop_size_y[1]))
